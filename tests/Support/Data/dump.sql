...
--
-- Host: db_test    Database: wordpress
-- ------------------------------------------------------
...
(2,'siteurl','http://localhost:8012','on'),
(3,'home','http://localhost:8012','on'),
(4,'blogname','future-free-wp_test','on'),
...
(1,'admin','$wp$2y$12$p3/sGshEtwRQ//ZQtYDAK.rfXD1irtjwRhSbBLZ9nsIjoqUP9Sqfq','admin','test@example.com','http://localhost:8012','2025-04-22 23:48:19','',0,'admin');
