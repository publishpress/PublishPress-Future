...
if (! class_exists('Classic_Editor')) :
    class Classic_Editor
    {
		...
		<div class="classic-editor-options">
			<p>
				<input type="radio" name="classic-editor-replace" id="classic-editor-classic" value="classic"<?php if ($settings['editor'] === 'classic') {
				    echo ' checked';
				} ?> />
				<label for="classic-editor-classic"><?php _ex('Classic editor', 'Editor Name', 'classic-editor'); ?></label>
			</p>
			<p>
				<input type="radio" name="classic-editor-replace" id="classic-editor-block" value="block"<?php if ($settings['editor'] !== 'classic') {
				    echo ' checked';
				} ?> />
		...
		<div class="classic-editor-options">
			<p>
				<input type="radio" name="classic-editor-allow-users" id="classic-editor-allow" value="allow"<?php if ($settings['allow-users']) {
				    echo ' checked';
				} ?> />
				<label for="classic-editor-allow"><?php _e('Yes', 'classic-editor'); ?></label>
			</p>
			<p>
				<input type="radio" name="classic-editor-allow-users" id="classic-editor-disallow" value="disallow"<?php if (! $settings['allow-users']) {
				    echo ' checked';
				} ?> />
		...
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<p>
						<input type="radio" name="classic-editor-replace" id="classic-editor-classic" value="classic"<?php if ($editor !== 'block') {
						    echo ' checked';
						} ?> />
						<label for="classic-editor-classic"><?php _ex('Classic editor', 'Editor Name', 'classic-editor'); ?></label>
					</p>
					<p>
						<input type="radio" name="classic-editor-replace" id="classic-editor-block" value="block"<?php if ($editor === 'block') {
						    echo ' checked';
						} ?> />
						<label for="classic-editor-block"><?php _ex('Block editor', 'Editor Name', 'classic-editor'); ?></label>
					</p>
			...
			<tr>
				...
				<td>
					<input type="checkbox" name="classic-editor-allow-sites" id="classic-editor-allow-sites" value="allow"<?php if ($is_checked) {
					    echo ' checked';
					} ?>>
