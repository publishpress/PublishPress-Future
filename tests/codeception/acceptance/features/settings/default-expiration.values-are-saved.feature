Feature: Settings - Tab Post Types - Values are saved
  ...
  Scenario Outline: Saving settings for different post types
    ...
    # And I set Who to Notify as "<how_to_notify>" for "<post_type>"
    # And I set Default Date as "<default_date>" for "<post_type>"
    # And I set Default Date Custom as "<default_date_custom>" for "<post_type>"
    ...
    Examples:
    | post_type | active   | how_to_expire | auto_enable | taxonomy | who_to_notify    | default_date | default_date_custom |
