...
var _window$publishpressF = window.publishpressFutureBulkEditConfig,
...
inlineEditPost.setBulk = function (id) {
  ...
  if ((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.select)(storeName)) {
    ...
    (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.dispatch)(storeName).setTerms(postTypeDefaultConfig.terms);
  ...
  var root = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createRoot)(container);
