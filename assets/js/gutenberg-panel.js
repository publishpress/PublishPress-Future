    ...
    var PostExpiratorSidebar = function (_Component) {
        ...
        _createClass(PostExpiratorSidebar, [{
            ...
            value: function render() {
                ...
                var actionsList = [{ label: config.strings.draft, value: 'draft' }, { label: config.strings.delete, value: 'delete' }, { label: config.strings.trash, value: 'trash' }, { label: config.strings.private, value: 'private' }, { label: config.strings.stick, value: 'stick' }, { label: config.strings.unstick, value: 'unstick' }];

                if (postType !== 'page') {
                    actionsList = _.union(actionsList, [{ label: config.strings.categoryReplace, value: 'category' }, { label: config.strings.categoryAdd, value: 'category-add' }, { label: config.strings.categoryRemove, value: 'category-remove' }]);
                }
