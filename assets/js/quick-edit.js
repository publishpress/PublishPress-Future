...
var createStore = exports.createStore = function createStore(props) {
    ...
    var store = (0, _wp.createReduxStore)(props.name, {
 ...
 */
_window.inlineEditPost.edit = function (button, id) {
    ...
    if ((0, _wp2.select)(storeName)) {
        (0, _wp2.dispatch)(storeName).setEnabled(enabled);
        (0, _wp2.dispatch)(storeName).setAction(action);
        (0, _wp2.dispatch)(storeName).setDate(date);
        (0, _wp2.dispatch)(storeName).setTaxonomy(taxonomy);
        (0, _wp2.dispatch)(storeName).setTerms(terms);
        (0, _wp2.dispatch)(storeName).setNewStatus(newStatus);
    } else {
        (0, _data.createStore)({
            name: storeName,
            defaultState: {
