...
docker exec $args pe_wordpress sudo cd /var/www/html/wp-content/plugins/post-expirator
docker exec $args pe_wordpress sudo export show=false url=http://wp.lvh.me:80/
docker exec $args pe_wordpress sudo npm install
docker exec $args pe_wordpress sudo npm run e2e:run
