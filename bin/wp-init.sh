...
docker exec $args pe_wordpress wp --allow-root post create --post_status=publish --post_category="apple" --import_id=1000
...
docker exec $args pe_wordpress wp --allow-root post create --post_status=publish --post_category="banana" --import_id=1001
docker exec $args pe_wordpress wp --allow-root post term remove 1000 category 'uncategorized'
