...
The Workflow Builder development mode allows you to see hidden details about the nodes and connections in the Workflow Editor. This mode is useful for developers who are creating custom data types and actions for the Workflow Editor.
