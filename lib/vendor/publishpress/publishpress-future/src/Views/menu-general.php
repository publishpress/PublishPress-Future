                    ...
                    <td>
                        <div id="expired-custom-container" class="pe-custom-date-container">
                            ...
                            <p class="description"><?php
                                echo sprintf(
                                    // translator: %1$s is the link to the PHP strtotime function documentation, %2$s and %3$s are the opening and closing code tags. Please, do not translate the date format text, since PHP will not be able to calculate using non-english terms.
                                    esc_html__(
