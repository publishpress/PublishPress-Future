...
export PLUGIN_NAME="publishpress-future-pro"
export LANG_DOMAIN="publishpress-future-pro"
export LANG_DIR="languages"

# Space separated list of locales that the plugin supports in scripts
export LANG_LOCALES="pt_BR it_IT es_ES fr_FR"
