    ...
    return (
        <div>
            <PersistentPanelBody
                ...
                title={__('Ray Debug', 'publishpress-future-pro')}
                initialOpen={true}
                disabled={isLoadingWorkflow}
            >
                <PanelRow>
                    <p>{__('Enable or disable the different types of debug information that is shown in Ray when this workflow is activated.', 'publishpress-future-pro')}</p>
                </PanelRow>
                <PanelRow>
                    <ToggleControl
                        label={__('Show Queries', 'publishpress-future-pro')}
                        checked={showQueries}
                ...
                <PanelRow>
                    <ToggleControl
                        label={__('Show Emails', 'publishpress-future-pro')}
                        checked={showEmails}
                ...
                <PanelRow>
                    <ToggleControl
                        label={__('Show WordPress Errors', 'publishpress-future-pro')}
