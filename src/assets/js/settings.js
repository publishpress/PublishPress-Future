...
/* harmony export */ });
/* harmony import */ var _wp_element__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! &wp.element */ "&wp.element");
/* harmony import */ var _wp_element__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wp_element__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! &wp.components */ "&wp.components");
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wp_components__WEBPACK_IMPORTED_MODULE_1__);
...
var CheckboxControl = function CheckboxControl(props) {
  var _useState = (0,_wp_element__WEBPACK_IMPORTED_MODULE_0__.useState)(props.checked || false),
  ...
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_1__.CheckboxControl, {
    label: props.label,
    name: props.name,
    id: props.name,
...
var DateTimePicker = function DateTimePicker(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_1__.DateTimePicker, {
...
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ */ "./lib/vendor/publishpress/publishpress-future/assets/jsx/components/index.jsx");
/* harmony import */ var _wp_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! &wp.data */ "&wp.data");
/* harmony import */ var _wp_data__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wp_data__WEBPACK_IMPORTED_MODULE_1__);
...
var FutureActionPanelClassicEditor = function FutureActionPanelClassicEditor(props) {
  ...
  var onChangeData = function onChangeData(attribute, value) {
    var store = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.select)(props.storeName);
...
var FutureActionPanelQuickEdit = function FutureActionPanelQuickEdit(props) {
  var onChangeData = function onChangeData(attribute, value) {};
  var date = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getDate();
  }, []);
  var enabled = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getEnabled();
  }, []);
  var action = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getAction();
  }, []);
  var terms = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getTerms();
  }, []);
  var taxonomy = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getTaxonomy();
  }, []);
  var hasValidData = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getHasValidData();
  }, []);
  var newStatus = (0,_wp_data__WEBPACK_IMPORTED_MODULE_1__.useSelect)(function (select) {
    return select(props.storeName).getNewStatus();
  }, []);
  var termsString = terms;
  if (_typeof(terms) === 'object') {
...
var NonceControl = function NonceControl(props) {
  ...
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/React.createElement("input", {
    type: "hidden",
    name: props.name,
    id: props.name,
    value: props.nonce
...
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ */ "./lib/vendor/publishpress/publishpress-future/assets/jsx/components/index.jsx");
/* harmony import */ var _wp_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! &wp.element */ "&wp.element");
/* harmony import */ var _wp_element__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_wp_element__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _wp_url__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! &wp.url */ "&wp.url");
/* harmony import */ var _wp_url__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wp_url__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _wp_hooks__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! &wp.hooks */ "&wp.hooks");
/* harmony import */ var _wp_hooks__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wp_hooks__WEBPACK_IMPORTED_MODULE_3__);
...
var PostTypeSettingsPanel = function PostTypeSettingsPanel(props) {
  ...
  var _useState = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.taxonomy),
    _useState2 = _slicedToArray(_useState, 2),
    postTypeTaxonomy = _useState2[0],
    setPostTypeTaxonomy = _useState2[1];
  var _useState3 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)([]),
    _useState4 = _slicedToArray(_useState3, 2),
    termOptions = _useState4[0],
    setTermOptions = _useState4[1];
  var _useState5 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
    _useState6 = _slicedToArray(_useState5, 2),
    termsSelectIsLoading = _useState6[0],
    setTermsSelectIsLoading = _useState6[1];
  var _useState7 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)([]),
    _useState8 = _slicedToArray(_useState7, 2),
    selectedTerms = _useState8[0],
    setSelectedTerms = _useState8[1];
  var _useState9 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.howToExpire),
    _useState10 = _slicedToArray(_useState9, 2),
    settingHowToExpire = _useState10[0],
    setSettingHowToExpire = _useState10[1];
  var _useState11 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.active),
    _useState12 = _slicedToArray(_useState11, 2),
    isActive = _useState12[0],
    setIsActive = _useState12[1];
  var _useState13 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.defaultExpireOffset),
    _useState14 = _slicedToArray(_useState13, 2),
    expireOffset = _useState14[0],
    setExpireOffset = _useState14[1];
  var _useState15 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.emailNotification),
    _useState16 = _slicedToArray(_useState15, 2),
    emailNotification = _useState16[0],
    setEmailNotification = _useState16[1];
  var _useState17 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.autoEnabled),
    _useState18 = _slicedToArray(_useState17, 2),
    isAutoEnabled = _useState18[0],
    setIsAutoEnabled = _useState18[1];
  var _useState19 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
    _useState20 = _slicedToArray(_useState19, 2),
    hasValidData = _useState20[0],
    setHasValidData = _useState20[1];
  var _useState21 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(''),
    _useState22 = _slicedToArray(_useState21, 2),
    validationError = _useState22[0],
    setValidationError = _useState22[1];
  var _useState23 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(''),
    _useState24 = _slicedToArray(_useState23, 2),
    taxonomyLabel = _useState24[0],
    setTaxonomyLabel = _useState24[1];
  var _useState25 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(originalExpireTypeList),
    _useState26 = _slicedToArray(_useState25, 2),
    howToExpireList = _useState26[0],
    setHowToExpireList = _useState26[1];
  var _useState27 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(props.settings.newStatus),
    _useState28 = _slicedToArray(_useState27, 2),
    newStatus = _useState28[0],
    setNewStatus = _useState28[1];
  var _useState29 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false),
    _useState30 = _slicedToArray(_useState29, 2),
    hasPendingValidation = _useState30[0],
    setHasPendingValidation = _useState30[1];
  var _useState31 = (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useState)(''),
  ...
  var validateData = function validateData() {
    ...
    if (expireOffset) {
      ...
      (0,_wp__WEBPACK_IMPORTED_MODULE_4__.apiFetch)({
        path: (0,_wp_url__WEBPACK_IMPORTED_MODULE_2__.addQueryArgs)("publishpress-future/v1/settings/validate-expire-offset"),
        method: 'POST',
        data: {
          offset: expireOffset
        },
  ...
  (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
  ...
  (0,_wp_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function () {
    ...
    (0,_wp__WEBPACK_IMPORTED_MODULE_4__.apiFetch)({
      path: (0,_wp_url__WEBPACK_IMPORTED_MODULE_2__.addQueryArgs)("publishpress-future/v1/terms/".concat(postTypeTaxonomy))
    }).then(function (result) {
      var options = [];
  ...
  if (isActive) {
    ...
    }), offsetPreview && /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, /*#__PURE__*/React.createElement("h4", null, props.text.datePreview), /*#__PURE__*/React.createElement("code", null, offsetPreview))));
    settingsRows.push( /*#__PURE__*/React.createElement(___WEBPACK_IMPORTED_MODULE_0__.SettingRow, {
  ...
  settingsRows = (0,_wp_hooks__WEBPACK_IMPORTED_MODULE_3__.applyFilters)('expirationdate_settings_posttype', settingsRows, props, isActive, _wp_element__WEBPACK_IMPORTED_MODULE_1__.useState);
...
var SelectControl = function SelectControl(props) {
  ...
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, props.options.length === 0 && /*#__PURE__*/React.createElement("div", null, props.noItemFoundMessage), props.options.length > 0 && /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_1__.SelectControl, {
    label: props.label,
    name: props.name,
    id: props.name,
    className: props.className,
...
var SettingsSection = function SettingsSection(props) {
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/React.createElement("h2", null, props.title), /*#__PURE__*/React.createElement("p", null, props.description), props.children);
};
...
var TextControl = function TextControl(props) {
  ...
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/React.createElement("div", {
    className: className
  }, /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_1__.TextControl, {
    type: "text",
    label: props.label,
    name: props.name,
    id: props.name,
...
/* harmony export */ });
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! &wp.components */ "&wp.components");
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wp_components__WEBPACK_IMPORTED_MODULE_0__);
...
var ToggleArrowButton = function ToggleArrowButton(props) {
  ...
  return /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_0__.Button, {
    isSmall: true,
    title: title,
    icon: icon,
    onClick: onClick,
...
var ToggleCalendarDatePicker = function ToggleCalendarDatePicker(_ref) {
  var isExpanded = _ref.isExpanded,
    ...
    is12Hour = _ref.is12Hour,
    startOfWeek = _ref.startOfWeek;
  (0,_wp_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(function () {
  ...
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, /*#__PURE__*/React.createElement(_ToggleArrowButton__WEBPACK_IMPORTED_MODULE_0__.ToggleArrowButton, {
...
var TokensControl = function TokensControl(props) {
  var _useState = (0,_wp_element__WEBPACK_IMPORTED_MODULE_0__.useState)(''),
    _useState2 = _slicedToArray(_useState, 2),
    stringValue = _useState2[0],
    setStringValue = _useState2[1];
  (0,_wp_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    if (props.value) {
  ...
  return /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_1__.FormTokenField, {
    label: props.label,
    value: value,
...
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! &wp.components */ "&wp.components");
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wp_components__WEBPACK_IMPORTED_MODULE_2__);
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
function _arrayWithoutHoles(arr) { if (Array.isArray(arr)) return _arrayLikeToArray(arr); }
...
var addCustomStatusSettings = function addCustomStatusSettings(settingsRows, props, settingActive, useState) {
  ...
  if (settingActive) {
    ...
    var postStatusesCheckboxes = _config_pro_settings__WEBPACK_IMPORTED_MODULE_1__.customPostStatuses.map(function (postStatus) {
      ...
      return /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_2__.CheckboxControl, {
        key: fieldId,
    ...
    }, /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      variant: "link",
      onClick: handleSelectAll
    }, _config_pro_settings__WEBPACK_IMPORTED_MODULE_1__.text.selectAll), " | ", /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      variant: "link",
...
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! &wp.components */ "&wp.components");
/* harmony import */ var _wp_components__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wp_components__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _wp_element__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! &wp.element */ "&wp.element");
/* harmony import */ var _wp_element__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_wp_element__WEBPACK_IMPORTED_MODULE_3__);
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
...
var MetadataMapTable = function MetadataMapTable(props) {
  ...
  return /*#__PURE__*/React.createElement("table", {
    ...
    }, field.label), /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_2__.Tooltip, {
...
var addMetadataSettings = function addMetadataSettings(settingsRows, props, settingActive, useState) {
  ...
  if (settingActive) {
    ...
    }, /*#__PURE__*/React.createElement(FieldRow, null, /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_2__.CheckboxControl, {
    ...
    }), /*#__PURE__*/React.createElement(HelpText, null, _config_pro_settings__WEBPACK_IMPORTED_MODULE_1__.text.enableMetadataDrivenSchedulingHelp)), enableMetadataMapping && /*#__PURE__*/React.createElement(_wp_element__WEBPACK_IMPORTED_MODULE_3__.Fragment, null, /*#__PURE__*/React.createElement(FieldRow, null, /*#__PURE__*/React.createElement(_wp_components__WEBPACK_IMPORTED_MODULE_2__.CheckboxControl, {
...
/* harmony import */ var _wp_hooks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! &wp.hooks */ "&wp.hooks");
/* harmony import */ var _wp_hooks__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wp_hooks__WEBPACK_IMPORTED_MODULE_2__);



(0,_wp_hooks__WEBPACK_IMPORTED_MODULE_2__.addFilter)('expirationdate_settings_posttype', 'publishpress/publishpress-future-pro', _custom_statuses__WEBPACK_IMPORTED_MODULE_0__.addCustomStatusSettings);
(0,_wp_hooks__WEBPACK_IMPORTED_MODULE_2__.addFilter)('expirationdate_settings_posttype', 'publishpress/publishpress-future-pro', _metadata_map__WEBPACK_IMPORTED_MODULE_1__.addMetadataSettings);
