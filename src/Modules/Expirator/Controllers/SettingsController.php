                ...
                wp_localize_script(
                    ...
                    [
                        'text' => [
                            ...
                            'fieldCustomStatusesLabel' => __('Enable custom statuses for the post type', 'post-expirator'),
                            'fieldMetadataScheduling' => __('Enable Metadata Scheduling', 'post-expirator'),
                            'fieldMetadataSchedulingLabel' => __('Enable metadata scheduling for the post type', 'post-expirator'),
                            'fieldMetadataSchedulingDescription' => __('Checking this option will allow you to use the post metadata to control the scheduling of Future actions in your content.', 'post-expirator'),
