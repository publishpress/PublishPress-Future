...
use PublishPress\FuturePro\Modules\Workflows\Domain\NodeTypes\Actions\CoreRemoveTermsToPost as NodeTypeCoreRemoveTermsToPost;
use PublishPress\FuturePro\Modules\Workflows\Interfaces\NodeRunnerInterface;
use PublishPress\FuturePro\Modules\Workflows\Interfaces\NodeRunnerPreparerInterface;

class CoreRemoveTermsToPost implements NodeRunnerInterface
{
    const NODE_NAME = NodeTypeCoreRemoveTermsToPost::NODE_NAME;
